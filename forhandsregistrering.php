                ...
                <div class="w3-row">
                    ...
                    <div>
                        ...
                        <div class=" w3-content w3-center register-container">
                            <p>E-post:</p>
                            <input type="text" name="place" value="" placeholder="deg@eksempel.no​" id="inputPlace"
                                   class="w3-input w3-animate-input" required id="inputPlace"><br>
                            <p>Fullt navn (valgfritt):</p>
                            <input type="text" name="name" value="" placeholder="Fornavn og etternavn"
                                   class="w3-input w3-animate-input" id="inputName"><br>

                            <p>Kommune (valgfritt):</p>
                            <input type="text" name="phone" value="" placeholder="Navnet på din kommune"
                                   class="w3-input w3-animate-input" id="inputPhone"><br>


                            <button class="white-button w3-card black-bg white-text border" type="submit"><i
                                        class="fas fa-paper-plane"></i> Registrer interesse
                            </button>
                            <p id="responseText"></p>
                        </div>
                    </div>
                    <div>
                        ...
                        <p>
                            Engasjer folk i arbeidet dere gjør og øk samtidig sjansen for å finne de beste ansatte for din bedrift.​
                        </p>
                            ...
                            <ul>
                                <li>
                                    <label>
                                        ...
                                        <input type="radio" name="client" value="elev" class="klient-radio w3-right"
                                               onclick="elevSelected()">
                                ...
                                <li>
                                    ...
                                    <label>
                                        <span>Student</span>
                                        <input type="radio" name="client" value="student" class="klient-radio  w3-right"
                                ...
                                <li>
                                    <label>
                                        ...
                                        <input type="radio" name="client" value="arbeidsledig" class="klient-radio w3-right"
                        ...
                        <div class=" w3-content w3-center w3-large register-content register-interests">
                            ...
                            <input type="checkbox" name="" value="" required> <label>Jeg har lest og godtatt <a
