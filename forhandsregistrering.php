                        ...
                        <div class=" w3-content w3-center w3-large register-content register-interests">
                            ...
                            <div class="w3-col m6 l6 s6">
                                <div class="w3-content w3-center">
                                    <input type="text" name="k1" value="" placeholder="Kvalifikasjon 1​" class="w3-input w3-animate-input" id="inputName">
                                </div>
                                <div class="w3-content w3-center">
                                    <input type="text" name="k2" value="" placeholder="Kvalifikasjon 2" class="w3-input w3-animate-input" id="inputName">
                                </div>
                                <div class="w3-content w3-center">
                                    <input type="text" name="k3" value="" placeholder="Kvalifikasjon 3" class="w3-input w3-animate-input" id="inputName">
                                </div>
                            </div>
                            <div class="w3-col m6 l6 s6 padding-bottom-16">
                                <div class="w3-content w3-center">
                                    <input type="text" name="i1" value="" placeholder="Interesse 1​​" class="w3-input w3-animate-input" id="inputName">
                                </div>
                                <div class="w3-content w3-center">
                                    <input type="text" name="i2" value="" placeholder="Interesse 2" class="w3-input w3-animate-input" id="inputName">
                                </div>
                                <div class="w3-content w3-center">
                                    <input type="text" name="i3" value="" placeholder="Interesse 3" class="w3-input w3-animate-input" id="inputName">
                                </div>
                            </div>
                            <br>
                            <label>
                                <p class="w3-margin">
                                    ...
                                    <input type="checkbox" name="personvern" id="personvern" value="student" class="klient-radio " onclick="studentSelected()" style="width:1px; position:relative; left:20px;">
                                    <i class="fas fa-user-tie w3-xlarge new-radio"></i>
                                </p>
                            </label>
                            <div>
