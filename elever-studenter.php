...
<body>
    ...
    ?>
    <div class="margin-top-100 full-height w3-row" style="height: calc(100vh - 100px);">
        <div class="w3-col s6 height-100 w3-display-container">
            <div class="bgimg-glade-pt1 z-index-1">
                Trykk her: elev
            </div>
            <div class="w3-card height-100 w3-large w3-padding white-bg width-500 sliding-text-right rightn-500 z-index-1" id="student-text">
                ...
                <a href="#" class="black-button w3-card">SE OG SØK PÅ ÅPNE PROSJEKTPLASSER I DITT OMRÅDE</a>
            </div>
        </div>
        <div class="w3-col s6 height-100 w3-display-container">
            <div class="w3-card height-100 w3-large w3-padding white-bg w3-display-left width-500 sliding-text-left z-index-1" id="pupil-text">
            ...
            <div class="bgimg-glade-pt2 z-index-1">
                Trykk her: student
            </div>
        </div>
    </div>
