...
<body>
    ...
    <div class="margin-top-100 mobile-no-flex" style="align-items: center;background-image: url('img/jobseeker.jpg');background-size: cover;background-repeat: no-repeat;background-position-y: center;height: calc(100vh - 80px);background-position-x: 600px;">
        <div class="gray-text w3-mobile w3-container w3-center white-bg w3-xlarge" style="flex-basis:600px;">
            <div class="margin-top-100">
                ...
                <p>Fortell om din nøkkelkompetanse, interesse og motivasjon.</p>
            </div>
            <div class="w3-padding-32">
                <img src="img/fig/network.png" alt="" style="width:20%;" class="">
                <p>Kom i kontakt med bedrifter via vårt automatiserte matching-system.</p>
            </div>
            <div class="">
