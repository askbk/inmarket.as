...
<body>
    ...
    <div class="margin-top-100 mobile-no-flex" style="align-items: center;background-image: url('img/jobseeker.jpg');background-size: cover;background-repeat: no-repeat;background-position-y: center;height: calc(100vh - 80px);background-position-x: 600px; overflow:hidden;">
