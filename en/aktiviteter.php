...
<head>
    <title>Activities | InMarket</title>
        ...
        <article class="w3-container w3-section">
            ...
            <div class="w3-row">
                ...
                <div class="w3-col m4 black-bg white-text w3-container w3-padding">
                    ...
                    <p>This we have launched along with new marketing strategy. Stay tuned to our further development!</p>
                </div>
            </div>
        </article>
        <article class="w3-container w3-section">
