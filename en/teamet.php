...
<body>
    ...
    <div class="w3-display-container parallax-img bgimg-sammy-oyvind-ask full-height margin-top-100">
        <article class="w3-display-bottommiddle white-text mobile-medium width-100 w3-container max-width-1200 w3-center" style="padding-bottom:50px;">
            <p>We work together as a team. We want to achieve great things for the Norwegian youth, Norwegian industry and contribute in international growth. We want to be part of the solution Norway uses to achieve greater international impact.</p>
            <p>The InMarket team consists of young leaders and employees working together to create Norway’s largest meeting place for employers and the rest of society.</p>
            <p>We want the process of recruiting employees not only to be about the little time it takes to publish position and finding employees. We want the hiring process to start earlier.</p>
        </article>
    </div>
    ...
    <div class="w3-row w3-center w3-container w3-large w3-center w3-padding-32 max-width-1200" style=" margin:auto;">
        <div class="w3-col m6 w3-padding-large w3-container">
            ...
            <p>
                As a manager at InMarket, you're responsible for your department. You'll have proper working conditions, great opportunities to develop your skill set and you'll be in direct communication with the board. You'll be able to guide, organize and follow up your own team and you are helping shape InMarket's goals and work process.
            </p>
        </div>
        <div class="w3-col m6 w3-padding-large w3-container">
            <img src="img/fig/ledelse.jpg" alt="" class="width-25-percent">
            <p>
                As an employee at InMarket, you will be able to use your expertise to solve specific tasks in our operation. We are looking primarily those who understand and have insight into the Norwegian labor market. Everything you do here can be linked to our vision to strengthen the Norwegian labor market in an international context.
            </p>
        </div>
    </div>
    ...
    <div class="w3-container w3-padding-64">
        ...
        <div class="horizontal-scroll w3-padding">
            ...
            <div class="w3-card-2 scroll-item" itemprop="employee" itemscope itemtype="http://schema.org/Person">
                ...
                <div class="hidden-description w3-right">
                    <div class="w3-padding">
                        <p class="white-space-normal w3-large">Øyvind has one year of experience as a soldier in the Air Force. He’s studying for a master's degree in electrical engineering at NTNU and has been the general manager of the compendium company Lumenia. Øyvind wants to challenge the status quo and always looks for opportunities to change attitudes and values in those he encounters.</p>
        ...
        <div class="horizontal-scroll w3-padding">
            <div class="w3-card-2 scroll-item" itemprop="employee" itemscope itemtype="http://schema.org/Person">
                <div class="width-300 w3-left">
                    ...
                    <div class="w3-container">
                        ...
                        <p class="w3-opacity" itemprop="jobTitle">CTO</p>
                        <p>Tel: (+47) <span itemprop="telephone">950 01 753</span><br>Email: <span itemprop="email">ask@inmarket.as</span></p>
                    </div>
                </div>
                <div class="hidden-description w3-right">
                    <div class="w3-padding">
                        <p class="white-space-normal w3-large">Ask is a former finalist in the Norwegian Informatics Olympiad. He's studying for a master's degree in computer science at NTNU and is primarily responsible for the development of the InMarket websites and the app. Ask has been through the school system in Norway and he wants to give same opportunities he had to other youth.</p>
            ...
            <div class="w3-card-2 scroll-item" itemprop="employee" itemscope itemtype="http://schema.org/Person">
                ...
                <div class="hidden-description w3-right">
                    <div class="w3-padding">
                        <p class="white-space-normal w3-large">Filip is studying for a bachelor’s in computer science at NTNU in Trondheim and is also a student assistant in the course Object-Oriented Programming. He has been involved in game development from a young age and is now motivated to make a difference in the education system in Norway.</p>
    ...
    <div class="w3-content w3-xlarge w3-padding-32">
        ...
        <div class="job-opening w3-padding-32" style="display:none;" id="webdesigner">
            <div class="w3-row w3-container w3-large">
                <div class="w3-col m6">
                    <h3>UX- and UI-designer</h3>
                    <p>Part time</p>
                    <p>As a UX and UI designer at InMarket, you will help shape the look and the user experience both on our platform and on our website.</p>
                    <p>We are looking for those who are able to put themselves in the end user's position, are creative and can work well in a team.</p>
                    <p>The position is unpaid as of now. We reward employees with stock options in the company.</p>
                    <p>1 open position</p>
                </div>
                <div class="w3-col m6">
        ...
        <div class="job-opening w3-padding-32" style="display:none;" id="developer">
            <div class="w3-row w3-container w3-large">
                <div class="w3-col m6">
                    <h3>Developer</h3>
                    <p>Part time</p>
                    <p>As a developer, you will mainly work with our upcoming platform. There are opportunities to work on the frontend, backend or full stack, according to your own wishes.</p>
                    <p>We work with full stack JavaScript. It's a big plus if you have relevant experience, but feel free to contact us anyway! We need those who can think systematically, work independently and have a high level of motivation.</p>
                    <p>The position is unpaid as of now. We reward employees with stock options in the company.</p>
